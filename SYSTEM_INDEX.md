...
| dev            | code specialist                           | minimax-m2.5          | read, write, exec, github, sessions_\*, session_status                        |
| father         | sysadmin / SSH / hardware                 | glm-4.7-flash         | read, exec, write, sessions_\*                                                |
| researcher     | web search / summarization                | gemini-2.5-flash      | read, browser, sessions_\*, session_status                                    |
| log-analyzer   | log scan / anomalies                      | deepseek-v3.2         | read, exec, sessions_\*, session_status                                       |
| qa-tester      | test runner                               | glm-4.7-flash         | read, exec, sessions_\*, session_status                                       |
| coder          | stateless code writer                     | minimax-m2.5          | read, write, exec, sessions_send, session_status                              |
| architect      | escalation handler / backlog              | gpt-5.2               | read, write, exec, sessions_\*, session_status                                |
| mother-relay   | batch message relay                       | glm-4.7-flash         | sessions_\*, session_status                                                   |
| sain-evaluator | SAIN n8n product scorer                   | gemini-2.0-flash-lite | defaults                                                                      |
| agora-host     | forum orchestrator                        | glm-4.7-flash         | read, write, sessions_\*, session_status                                      |
...
| red-team       | security analyst                          | kimi-k2.5             | read, write, sessions_send, session_status, memory_\*                         |
...
| deploy         | release pipeline coordinator              | gemini-2.5-flash      | read, write, exec, sessions_\*, session_status                                |
| notifier       | Telegram dispatcher                       | gemini-2.5-flash      | exec, sessions_send, session_status                                           |
| intel          | intelligence coordinator                  | gemini-2.5-flash      | read, write, browser, sessions_\*, session_status, memory_\*                  |
